...
public class DictionaryConnection4 {
     ...
     */
    public DictionaryConnection4(String host, int port) throws DictConnectionException {
        try {
     ...
     *                                 don't match their expected value.
     */
    public DictionaryConnection4(String host) throws DictConnectionException, IOException {
